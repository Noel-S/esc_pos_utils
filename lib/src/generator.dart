...
class Generator {
  ...
  List<List<int>> _toColumnFormat(Image imgSrc, int lineHeight) {
    ...
    fill(biggerImage, color: ColorInt8.rgb(0, 0, 0));
  ...
  List<int> image(Image imgSrc, {PosAlign align = PosAlign.center, bool highDensityHorizontal = true, bool highDensityVertical = true}) {
    List<int> bytes = [];
    // Image alignment
